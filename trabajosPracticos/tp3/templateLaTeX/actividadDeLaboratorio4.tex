...
\imagen[Simulación en LtSpice]{12cm}{./imagenes/beta.png}
...
\midTitle{Blue}{$I_C = f(I_B)$ para $V_{CE(inicial)} = 2V,5V$ y $8V$}{}

\imagen[$I_C = f(I_B)$ en Python]{14cm}{./imagenes/betaCurvaPython.png}
\newpage
\begin{minted}{python}
...
plt.xlabel('IB [uA]', fontsize=12)
plt.ylabel('IC [mA]', fontsize=12)
plt.title('I_C vs I_B', fontsize=14)
plt.grid(True, alpha=0.3)
plt.legend()

plt.text(0.02, 0.98, f'B (VCE=2V) = {beta2V:.1f}', transform=plt.gca().transAxes, 
         verticalalignment='top', bbox=dict(boxstyle='round', facecolor='red', alpha=0.3))
plt.text(0.02, 0.90, f'B (VCE=5V) = {beta5V:.1f}', transform=plt.gca().transAxes, 
         verticalalignment='top', bbox=dict(boxstyle='round', facecolor='green', alpha=0.3))
plt.text(0.02, 0.82, f'B (VCE=8V) = {beta8V:.1f}', transform=plt.gca().transAxes, 
