...
\sangria{} En esta actividad se busca observar si la relación entre la corriente de colector ($I_C$) y la de base ($I_B$) se mantiene constante en diferentes regiones de trabajo del transistor. Notese que la relación que se menciona es la ganancia de corriente. \\ \sangria{} Para comprobar la relación, se usará un transistor configurado en emisor común:
\begin{center}
\begin{tikzpicture}
