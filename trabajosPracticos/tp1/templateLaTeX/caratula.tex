...
\begin{tikzpicture}[remember picture, overlay]
	...
	\node [line width=2pt] at (7.5cm, -9cm) {\includegraphics[width=6cm]{./imagenes/portada.png}};
	...
	\begin{minipage}[c]{12cm}
	    \begin{itemize}
            ...
            \item \fontsize{12}{12}\selectfont \textbf{Autores:} 
                \begin{itemize} \item Manuel León Parfait - Leg. 406599 (Coordinador) \item Marcos Raúl Gatica - Leg. 402006 (Operador) \item Valentino Rao - Leg. 402308 (Documentador) \end{itemize}
