...
\begin{itemize}[nosep]
    ...
    \item Tanto $V_1$ como $V_2$ son fuentes variables de $\sim 0V$ a $\sim 10V$.
\end{itemize}
...
\begin{center}
\begin{tabular}{|
>{\columncolor[HTML]{68CBD0}}c |cc|cc|}
\hline
\textbf{\begin{tabular}[c]{@{}c@{}}$V_{CC}$\\ {[}V{]}\end{tabular}} &
  \multicolumn{2}{c|}{\cellcolor[HTML]{FFCC67}\textbf{\begin{tabular}[c]{@{}c@{}}$I_B = 10\mu A$\\ $V_{bb} = 1,6V$\end{tabular}}} &
  \multicolumn{2}{c|}{\cellcolor[HTML]{FFCC67}\textbf{\begin{tabular}[c]{@{}c@{}}$I_B = 15\mu A$\\ $V_{bb} = 2,2V$\end{tabular}}} \\ \hline
\textbf{} &
  \multicolumn{1}{c|}{\cellcolor[HTML]{FFCCC9}\textbf{$I_C$}} &
  \cellcolor[HTML]{FFCCC9}\textbf{$V_{CE}$} &
  \multicolumn{1}{c|}{\cellcolor[HTML]{FFCCC9}\textbf{$I_C$}} &
  \cellcolor[HTML]{FFCCC9}\textbf{$V_{CE}$} \\ \hline
\textbf{0}    & \multicolumn{1}{c|}{$116,4\mu A$}  & $-63,5mV$  & \multicolumn{1}{c|}{$130,98\mu A$} & $-72,01mV$ \\ \hline
\textbf{0,25} & \multicolumn{1}{c|}{$492,09\mu A$} & $-26,06mV$ & \multicolumn{1}{c|}{$518,03\mu A$} & $-40,09mV$ \\ \hline
\textbf{0,5}  & \multicolumn{1}{c|}{$903,9\mu A$}  & $-5,74mV$  & \multicolumn{1}{c|}{$932,81\mu A$} & $-22,37mV$ \\ \hline
\textbf{1}    & \multicolumn{1}{c|}{$1,74mA$}      & $23,68mV$  & \multicolumn{1}{c|}{$1,78mA$}      & $1,56mV$   \\ \hline
\textbf{2}    & \multicolumn{1}{c|}{$3,4mA$}       & $91,97mV$  & \multicolumn{1}{c|}{$3,50mA$}      & $38,4mV$   \\ \hline
\textbf{5}    & \multicolumn{1}{c|}{$4,0mA$}       & $2,757V$   & \multicolumn{1}{c|}{$6,38mA$}      & $1,4V$     \\ \hline
\textbf{10}   & \multicolumn{1}{c|}{$4,21mA$}      & $7,637V$   & \multicolumn{1}{c|}{$6,72mA$}      & $6,23V$    \\ \hline
\end{tabular}
\end{center}
...
\begin{tabular}{|
>{\columncolor[HTML]{68CBD0}}l |ll|ll|}
\hline
\begin{tabular}[c]{@{}l@{}}$V_{cc}$\\ {[}V{]}\end{tabular} &
  \multicolumn{2}{l|}{\cellcolor[HTML]{FFCC67}\begin{tabular}[c]{@{}l@{}}\cellcolor[HTML]{FFCC67}$IB=20\mu A$\\ $V_{bb}=2.6V$\end{tabular}} &
  \multicolumn{2}{l|}{\cellcolor[HTML]{FFCC67}\begin{tabular}[c]{@{}l@{}}\cellcolor[HTML]{FFCC67}$IB=25\mu A$\\ $V_{bb}=3.2V$\end{tabular}} \\ \hline
 &
...
\midTitle{blue}{Notas del documentador:}{valores $I_B = 0A$ y $V_{BB} = 0V$}
''Al momento de hacer las simulaciones, notamos que los valores de $I_C$ y $V_{CE}$ son absurdamente pequeños y consideramos despreciarlos.''
\newpage
\subsubsection{Conclusiones}

\midTitle{Green}{Aciertos$\checkmark$}{}
\sangria Las simulaciones ayudaron bastante a las curvas,ya que esta tabla fue más complizada para entender, por otro lado los instrumentos de medición adecuados fueron de gran ayuda para muestrear valores.

\midTitle{Red}{Dificultades \textbf{\textit{x}}}{}
\sangria Las dificultades fueron el tiempo de desarrollo de la implementación y la implementación de las curvas obtenidas en la etapa de simulación con LtSpice. Ambas relaciones no concordaban y se comenzó a dudar de la veracidad de alguna de las dos etapas. \\
\midTitle{blue}{Notas del documentador:}{Cómo lo solucionamos}
\sangria{} ''Junto al operador de la actividad estuvimos repasando las conexiones y los valores que obtendría viendo las junturas de entrada y salida. También corroboramos que los instrumentos estuvieran bien configurados (nótese que no es lo mismo la configuración de clavijas para corriente que tensión). Hemos dejado el inconveniente con el tiempo como punto a resolver dentro del grupo, proponiendo una estructura de pasos a seguir.''
\thispagestyle{fancy}
\valentinoQuitaLasColumnas{}
\subsubsection{Simulaciones Act 3}
\imagen[Simulación con LtSpice]{16cm}{./imagenes/curvasCaracteristicasSimulacion.png}
\midTitle{red}{Configuración}{}
\begin{itemize}
    \item Temperatura: $20^oC$
    \item $\beta$: 498
    \item $R_1$: $9,96k\Omega$, $R_2$: $556,40\Omega$ 
    \item $V_1$: $9,96V$
\end{itemize}
...
\imagen[Simulación de las curvas características con python]{16cm}{./imagenes/curvas_carac.png}
