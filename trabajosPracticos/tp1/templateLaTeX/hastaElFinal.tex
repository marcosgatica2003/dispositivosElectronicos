...
\subsection{Notas del documentador: Actividad 3}
    \sangria{} En la medición de la corriente a través de los resistores $R_2$ y $R_3$ se utilizó la escala de 60mA, ya que la escala de 600uA no era suficiente para medir la corriente, además tuvmos problemas con un multímetro, el cual no reflejaba las mediciones correctas.\\
    \sangria{} En la medición de la corriente a través del resistor $R_1$ se utilizó la escala de 600uA, ya que la escala de 60mA no era suficiente para medir la corriente.\\
