...
\imagen{8cm}{./imagenes/tensionalterna.jpg}
...
\begin{itemize}
    \item \textbf{Osciloscopio digital}
    \begin{itemize}
        \item \textbf{Fabricante:} [Completar]
        \item \textbf{Modelo:} [Completar]
        \item \textbf{Serie:} [Completar]
    \end{itemize}
\end{itemize}

\imagen{8cm}{./imagenes/osciloscopioDigital.jpg}
...
\begin{center}
    ...
    \begin{tabular}{| m{4cm}| m{3cm} |}
        ...
        \multicolumn{2}{|c|}{\textbf{Información de mediciones}} \\
        \hline
        \textbf{Resolución vertical} & [Completar] \\
        \hline
        \textbf{Velocidad de muestreo} & [Completar] \\
        \hline
        \textbf{Ancho de banda} & [Completar] \\
        \hline
    \end{tabular}
\end{center}
...
\imagen{8cm}{./imagenes/multimetroAdicional.jpg}
...
\begin{center}
    ...
    \begin{tabular}{| m{4cm}| m{3cm} |}
        ...
        \multicolumn{2}{|c|}{\textbf{Información de mediciones}} \\
        \hline
        \textbf{Tensión CC} & [Completar] \\
        \hline
        \textbf{Corriente CA} & [Completar] \\
        \hline
        \textbf{Resistencia} & [Completar] \\
        \hline
    \end{tabular}
\end{center}
