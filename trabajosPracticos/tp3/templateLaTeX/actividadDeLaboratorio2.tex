...
\imagen[Distribución de pines del BC548C]{6cm}{./imagenes/patasBC547C.jpeg}
...
\hline
\cellcolor[HTML]{CBCEFB}\rowcolor[HTML]{FFFFC7} \cellcolor[HTML]{CBCEFB}\textbf{$V_{BB}$} &
  \textbf{500mV} &
  \textbf{1V} &
  \textbf{2V} &
  \textbf{3V} &
  \textbf{4V} &
  \textbf{10V} \\ \hline
\cellcolor[HTML]{CBCEFB}\cellcolor[HTML]{CBCEFB}\textbf{$I_B$} &
  0$mA$ &
  0.028$mA$ &
  0.126$mA$ &
  0.226$mA$ &
  0.326$mA$ &
  0.924$mA$ \\ \hline
\cellcolor[HTML]{CBCEFB}\cellcolor[HTML]{CBCEFB}\textbf{$V_{BE}$} &
  0.713$V$ &
  0.717$V$ &
  0,725$V$ &
  0.731$V$ &
...
\sangria{}Teniamos mal polarizado nuestro transistor, entonces la corriente $I_{B}$, se mantenia fija para todo cambio en $V_{BB}$.
...
\subsubsection{Simulación Act 2}
